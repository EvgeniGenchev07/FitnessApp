...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 334, ; uint32_t number_of_assemblies_in_apk
...
@dso_cache = dso_local local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libSkiaSharp.so
		ptr null; void* handle
	}, ; 5
	%struct.DSOCacheEntry {
...
@bundled_assemblies = dso_local local_unnamed_addr global [334 x %struct.XamarinAndroidBundledAssembly] [
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.fitnessapp\00", align 16
...
@.DSOCacheEntry.11_name = private unnamed_addr constant [16 x i8] c"libSkiaSharp.so\00", align 16
